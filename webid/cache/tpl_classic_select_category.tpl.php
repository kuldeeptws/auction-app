...
<?php $_boxes_count = (isset($this->_tpldata['boxes'])) ? sizeof($this->_tpldata['boxes']) : 0;if ($_boxes_count) {for ($_boxes_i = 0; $_boxes_i < $_boxes_count; ++$_boxes_i){$_boxes_val = &$this->_tpldata['boxes'][$_boxes_i]; ?>
					<td align="center" style="width:<?php echo $_boxes_val['PERCENT']; ?>%;">
						<select name="cat<?php echo $_boxes_val['I']; ?>" class="box" size="15" onchange="SubmitBoxes(<?php echo $_boxes_val['I']; ?>)" style="width:230px;">
...
<?php if ($this->_rootref['B_SHOWBUTTON']) {  ?>
						<input type="submit" name="submitit" value="<?php if ($this->_rootref['B_EDITING']) {  echo ((isset($this->_rootref['L_25_0168'])) ? $this->_rootref['L_25_0168'] : ((isset($MSG['25_0168'])) ? $MSG['25_0168'] : '{ L_25_0168 }')); } else { echo ((isset($this->_rootref['L_2__0047'])) ? $this->_rootref['L_2__0047'] : ((isset($MSG['2__0047'])) ? $MSG['2__0047'] : '{ L_2__0047 }')); } ?>" class="button">
<?php } ?>
					</td>
				</tr>
			</table>
