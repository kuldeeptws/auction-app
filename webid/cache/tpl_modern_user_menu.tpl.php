...
<?php if ($this->_rootref['THISPAGE'] == ('account')) {  ?>
	...
	<a class="list-group-item" href="leave_feedback.php"><?php echo ((isset($this->_rootref['L_207'])) ? $this->_rootref['L_207'] : ((isset($MSG['207'])) ? $MSG['207'] : '{ L_207 }')); echo (isset($this->_rootref['FBTOLEAVE'])) ? $this->_rootref['FBTOLEAVE'] : ''; ?></a>
...
<?php } else if ($this->_rootref['THISPAGE'] == ('selling')) {  if ($this->_rootref['B_CANSELL']) {  ?>
	...
	<?php } if ($this->_rootref['B_CANSELL']) {  ?>
	...
	<?php } else if ($this->_rootref['B_CANREQUESTSELL']) {  ?>
