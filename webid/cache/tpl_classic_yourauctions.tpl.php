...
<form name="auctions" method="post" action="" id="processdel">
	...
	<dl class="tabs">
		<dd class="active"><a href="yourauctions.php"><?php echo ((isset($this->_rootref['L_619'])) ? $this->_rootref['L_619'] : ((isset($MSG['619'])) ? $MSG['619'] : '{ L_619 }')); ?></a></dd>
...
<?php if ($this->_rootref['B_AREITEMS']) {  $_items_count = (isset($this->_tpldata['items'])) ? sizeof($this->_tpldata['items']) : 0;if ($_items_count) {for ($_items_i = 0; $_items_i < $_items_count; ++$_items_i){$_items_val = &$this->_tpldata['items'][$_items_i]; ?>
		...
		<?php if ($_items_val['B_HASNOBIDS']) {  ?>
				<a href="edit_active_auction.php?id=<?php echo $_items_val['ID']; ?>" title="<?php echo ((isset($this->_rootref['L_click_to_edit_auction'])) ? $this->_rootref['L_click_to_edit_auction'] : ((isset($MSG['click_to_edit_auction'])) ? $MSG['click_to_edit_auction'] : '{ L_click_to_edit_auction }')); ?>"><img src="images/edititem.gif" width="13" height="17" alt="<?php echo ((isset($this->_rootref['L_512'])) ? $this->_rootref['L_512'] : ((isset($MSG['512'])) ? $MSG['512'] : '{ L_512 }')); ?>" border="0"></a>
		<?php } else { ?>
				<img src="images/info.gif" title="<?php echo ((isset($this->_rootref['L_edit_disabled'])) ? $this->_rootref['L_edit_disabled'] : ((isset($MSG['edit_disabled'])) ? $MSG['edit_disabled'] : '{ L_edit_disabled }')); ?>" width="13" height="13" alt="<?php echo ((isset($this->_rootref['L_512'])) ? $this->_rootref['L_512'] : ((isset($MSG['512'])) ? $MSG['512'] : '{ L_512 }')); ?>" border="0">
		<?php } ?>
			</td>
		...
		<?php } else { ?>
				<img src="images/info.gif" title="<?php echo ((isset($this->_rootref['L_delete_auction_disabled'])) ? $this->_rootref['L_delete_auction_disabled'] : ((isset($MSG['delete_auction_disabled'])) ? $MSG['delete_auction_disabled'] : '{ L_delete_auction_disabled }')); ?>" width="13" height="13" alt="<?php echo ((isset($this->_rootref['L_512'])) ? $this->_rootref['L_512'] : ((isset($MSG['512'])) ? $MSG['512'] : '{ L_512 }')); ?>" border="0">
		<?php } ?>
			</td>
