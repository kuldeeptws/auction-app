...
<?php if ($this->_rootref['PAGE'] == (1)) {  if ($this->_rootref['ERROR'] != ('')) {  ?>
	...
	<?php } if ($this->_rootref['B_USERAUTH']) {  ?>
					<div class="form-group">
						<label class="col-sm-5 control-label"><?php echo ((isset($this->_rootref['L_username'])) ? $this->_rootref['L_username'] : ((isset($MSG['username'])) ? $MSG['username'] : '{ L_username }')); ?></label>
					...
					<div class="form-group">
						<label class="col-sm-5 control-label"><?php echo ((isset($this->_rootref['L_password'])) ? $this->_rootref['L_password'] : ((isset($MSG['password'])) ? $MSG['password'] : '{ L_password }')); ?></label>
