				...
				<form name="user_login" action="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>user_login.php" method="post">
					<div class="form-group col-md-10">
						...
						<div class="input-group">
							...
							<input type="password" name="password" class="form-control" placeholder="<?php echo ((isset($this->_rootref['L_password'])) ? $this->_rootref['L_password'] : ((isset($MSG['password'])) ? $MSG['password'] : '{ L_password }')); ?>" value="">
						</div>
					</div>
