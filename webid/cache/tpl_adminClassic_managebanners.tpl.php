<div style="width:25%; float:left;">
		...
		<div style="width:75%; float:right;">
			<div class="main-box">
				<h4 class="rounded-top rounded-bottom"><?php echo ((isset($this->_rootref['L_25_0011'])) ? $this->_rootref['L_25_0011'] : ((isset($MSG['25_0011'])) ? $MSG['25_0011'] : '{ L_25_0011 }')); ?>&nbsp;&gt;&gt;&nbsp;<?php echo ((isset($this->_rootref['L_banner_admin'])) ? $this->_rootref['L_banner_admin'] : ((isset($MSG['banner_admin'])) ? $MSG['banner_admin'] : '{ L_banner_admin }')); ?> : <?php echo ((isset($this->_rootref['L__0012'])) ? $this->_rootref['L__0012'] : ((isset($MSG['_0012'])) ? $MSG['_0012'] : '{ L__0012 }')); ?></h4>
...
<?php $_busers_count = (isset($this->_tpldata['busers'])) ? sizeof($this->_tpldata['busers']) : 0;if ($_busers_count) {for ($_busers_i = 0; $_busers_i < $_busers_count; ++$_busers_i){$_busers_val = &$this->_tpldata['busers'][$_busers_i]; ?>
					<tr<?php if ($_busers_val['S_ROW_COUNT'] % (2) == (1)) {  ?> class="bg"<?php } ?>>
