...
$(document).ready(function() {
	var timeRemaining = <?php echo (isset($this->_rootref['ENDS_IN'])) ? $this->_rootref['ENDS_IN'] : ''; ?>;
...
<div class="content">
	<div class="tableContent2">
		<div class="padding"><b><?php echo ((isset($this->_rootref['L_041'])) ? $this->_rootref['L_041'] : ((isset($MSG['041'])) ? $MSG['041'] : '{ L_041 }')); ?>:</b> <?php echo (isset($this->_rootref['TOPCATSPATH'])) ? $this->_rootref['TOPCATSPATH'] : ''; ?></div>
...
<?php if ($this->_rootref['B_HASIMAGE']) {  ?>
								<td width="10%" valign="top">
									<table bgcolor="#ffffff">
										<tr>
											<td align='center'>
												<img src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>getthumb.php?w=<?php echo (isset($this->_rootref['THUMBWIDTH'])) ? $this->_rootref['THUMBWIDTH'] : ''; ?>&fromfile=<?php echo (isset($this->_rootref['PIC_URL'])) ? $this->_rootref['PIC_URL'] : ''; ?>&auction_id=<?php echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>" border="0" align="center"><br>
...
<?php } ?>
									...
									<table width="100%" align="center" cellpadding="0" cellspacing="0" valign="top" border="0">
										<tr>
											...
											<td align="left" valign="top">
												<?php echo ((isset($this->_rootref['L_611'])) ? $this->_rootref['L_611'] : ((isset($MSG['611'])) ? $MSG['611'] : '{ L_611 }')); ?> <span style="color:#ff3300"><b><?php echo (isset($this->_rootref['AUCTION_VIEWS'])) ? $this->_rootref['AUCTION_VIEWS'] : ''; ?></b></span> <?php echo ((isset($this->_rootref['L_612'])) ? $this->_rootref['L_612'] : ((isset($MSG['612'])) ? $MSG['612'] : '{ L_612 }')); ?><br>
	...
	<?php $_high_bidders_count = (isset($this->_tpldata['high_bidders'])) ? sizeof($this->_tpldata['high_bidders']) : 0;if ($_high_bidders_count) {for ($_high_bidders_i = 0; $_high_bidders_i < $_high_bidders_count; ++$_high_bidders_i){$_high_bidders_val = &$this->_tpldata['high_bidders'][$_high_bidders_i]; ?>
		...
		<?php } ?>
																<img src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>images/icons/<?php echo $_high_bidders_val['BUYER_FB_ICON']; ?>" alt="<?php echo $_high_bidders_val['BUYER_FB_ICON']; ?>" class="fbstar">
															</p>
	<?php }} ?>
														</td>
													</tr>
...
<?php } if ($this->_rootref['B_BUY_NOW']) {  ?>
													<tr>
														...
														<td align="left"><?php echo (isset($this->_rootref['BUYNOW2'])) ? $this->_rootref['BUYNOW2'] : ''; ?></td>
													</tr>
						...
						<table width="100%" cellspacing="0" cellpadding="4" border="0" bgcolor="#ffffff">
							<tr>
								...
								<td class="table2" style="padding:10px;">
									...
									<?php if ($this->_rootref['SELLER_FB_ICON'] != ('')) {  ?><img src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>images/icons/<?php echo (isset($this->_rootref['SELLER_FB_ICON'])) ? $this->_rootref['SELLER_FB_ICON'] : ''; ?>" alt="<?php echo (isset($this->_rootref['SELLER_FB_ICON'])) ? $this->_rootref['SELLER_FB_ICON'] : ''; ?>" class="fbstar"><?php } ?>
								</td>
							</tr>
							<tr>
								<td width="3%">&nbsp;</td>
...
<?php if ($this->_rootref['B_HASENDED'] == (false) && $this->_rootref['B_CAN_BUY']) {  if ($this->_rootref['B_NOTBNONLY']) {  ?>
	...
	<?php } else { ?>
							<?php echo (isset($this->_rootref['BUYNOW'])) ? $this->_rootref['BUYNOW'] : ''; ?> <a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>buy_now.php?id=<?php echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>"><img border="0" align="absbottom" alt="<?php echo ((isset($this->_rootref['L_496'])) ? $this->_rootref['L_496'] : ((isset($MSG['496'])) ? $MSG['496'] : '{ L_496 }')); ?>" src="<?php echo (isset($this->_rootref['BNIMG'])) ? $this->_rootref['BNIMG'] : ''; ?>"></a>
	<?php } } if ($this->_rootref['B_CAN_BUY'] == (false)) {  ?>
							<p><?php echo ((isset($this->_rootref['L_5002'])) ? $this->_rootref['L_5002'] : ((isset($MSG['5002'])) ? $MSG['5002'] : '{ L_5002 }')); ?></p>
							<p><a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>user_login.php?"><?php echo ((isset($this->_rootref['L_221'])) ? $this->_rootref['L_221'] : ((isset($MSG['221'])) ? $MSG['221'] : '{ L_221 }')); ?></a></p>
<?php } ?>
						</div>
						<a class="report-item rightside" href='<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>item_report.php?id=<?php echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>'><?php echo ((isset($this->_rootref['L_report_this_item'])) ? $this->_rootref['L_report_this_item'] : ((isset($MSG['report_this_item'])) ? $MSG['report_this_item'] : '{ L_report_this_item }')); ?></a>
					</td>
				</tr>
			</table>
			<br>
			<div class="tableContent2">
				...
				<div class="table2"><?php echo (isset($this->_rootref['AUCTION_DESCRIPTION'])) ? $this->_rootref['AUCTION_DESCRIPTION'] : ''; ?></div>
			</div>
	...
	<?php $_gallery_count = (isset($this->_tpldata['gallery'])) ? sizeof($this->_tpldata['gallery']) : 0;if ($_gallery_count) {for ($_gallery_i = 0; $_gallery_i < $_gallery_count; ++$_gallery_i){$_gallery_val = &$this->_tpldata['gallery'][$_gallery_i]; ?>
							<td>
								<a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; echo (isset($this->_rootref['UPLOADEDPATH'])) ? $this->_rootref['UPLOADEDPATH'] : ''; echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>/<?php echo $_gallery_val['V']; ?>" title="" data-lightbox="gallery">
									<img src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>getthumb.php?w=<?php echo (isset($this->_rootref['THUMBWIDTH'])) ? $this->_rootref['THUMBWIDTH'] : ''; ?>&fromfile=<?php echo $_gallery_val['V']; ?>&auction_id=<?php echo (isset($this->_rootref['ID'])) ? $this->_rootref['ID'] : ''; ?>" border="0" hspace="10">
								</a>
							</td>
	<?php }} ?>
						</tr>
...
<?php } ?>
			<br>
			<div class="titTable4"><?php echo ((isset($this->_rootref['L_724'])) ? $this->_rootref['L_724'] : ((isset($MSG['724'])) ? $MSG['724'] : '{ L_724 }')); ?></div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						<div class="tableContent2">
...
<?php if ($this->_rootref['SECCATSPATH'] != ('')) {  ?>
								<b><?php echo ((isset($this->_rootref['L_814'])) ? $this->_rootref['L_814'] : ((isset($MSG['814'])) ? $MSG['814'] : '{ L_814 }')); ?>:</b> <?php echo (isset($this->_rootref['SECCATSPATH'])) ? $this->_rootref['SECCATSPATH'] : ''; ?>
<?php } ?>
							</div>
						</div>
					</td>
