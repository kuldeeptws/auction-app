...
<?php } if ($this->_rootref['PAGE'] == 0) {  ?>
	...
	<?php } if ($this->_rootref['B_EDIT_STARTTIME']) {  ?>
		...
		<?php } else { ?>
							<?php echo ((isset($this->_rootref['L_211'])) ? $this->_rootref['L_211'] : ((isset($MSG['211'])) ? $MSG['211'] : '{ L_211 }')); ?> <input type="checkbox" name="start_now" id="start_now" <?php echo (isset($this->_rootref['START_NOW'])) ? $this->_rootref['START_NOW'] : ''; ?>><br>
	...
	<?php } if ($this->_rootref['B_EDIT_ENDTIME']) {  ?>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><?php echo ((isset($this->_rootref['L_custom_end_time'])) ? $this->_rootref['L_custom_end_time'] : ((isset($MSG['custom_end_time'])) ? $MSG['custom_end_time'] : '{ L_custom_end_time }')); ?></b>
						</td>
						<td class="rightpan">
							<input type="checkbox" id="custom_end" name="custom_end" <?php echo (isset($this->_rootref['CUSTOM_END'])) ? $this->_rootref['CUSTOM_END'] : ''; ?>>
						</td>
					</tr>
	<?php } ?>
					<tr>
						<td align="right" width="25%" valign="top" class="leftpan">
							<b><?php echo ((isset($this->_rootref['L_ending_date'])) ? $this->_rootref['L_ending_date'] : ((isset($MSG['ending_date'])) ? $MSG['ending_date'] : '{ L_ending_date }')); ?></b>
						</td>
						<td class="rightpan">
	...
	<?php } if ($this->_rootref['B_CAN_TAX']) {  ?>
					<tr>
						...
						<td class="rightpan">
							<input type="radio" name="is_taxed" value="1" <?php echo (isset($this->_rootref['TAX_Y'])) ? $this->_rootref['TAX_Y'] : ''; ?>>	<?php echo ((isset($this->_rootref['L_yes'])) ? $this->_rootref['L_yes'] : ((isset($MSG['yes'])) ? $MSG['yes'] : '{ L_yes }')); ?><br>
					...
					<tr>
						...
						<td class="rightpan">
							<input type="radio" name="tax_included" value="1" <?php echo (isset($this->_rootref['TAXINC_Y'])) ? $this->_rootref['TAXINC_Y'] : ''; ?>>	<?php echo ((isset($this->_rootref['L_yes'])) ? $this->_rootref['L_yes'] : ((isset($MSG['yes'])) ? $MSG['yes'] : '{ L_yes }')); ?><br>
	...
	<?php } if ($this->_rootref['B_FEES']) {  ?>
					<tr>
						<td align="right" width="25%" valign="middle">
							<b><?php echo ((isset($this->_rootref['L_1151'])) ? $this->_rootref['L_1151'] : ((isset($MSG['1151'])) ? $MSG['1151'] : '{ L_1151 }')); ?></b>
						</td>
						<td class="rightpan">
