<div style="width:25%; float:left;">
			...
			<div class="container">
				...
				<form name="errorlog" action="" method="post">
					...
					<input class="btn-primary btn" type="submit" name="act" class="centre" value="<?php echo ((isset($this->_rootref['L_530'])) ? $this->_rootref['L_530'] : ((isset($MSG['530'])) ? $MSG['530'] : '{ L_530 }')); ?>">
				</form>
			</div>
		</div>