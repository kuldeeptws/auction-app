...
<div style="position: absolute; right: 20%; margin-top:15px;">
	<form><input id="printpagebutton" type="button" value="<?php echo ((isset($this->_rootref['L_1060a'])) ? $this->_rootref['L_1060a'] : ((isset($MSG['1060a'])) ? $MSG['1060a'] : '{ L_1060a }')); ?>" onclick="printpage()"/></form>
</div>
