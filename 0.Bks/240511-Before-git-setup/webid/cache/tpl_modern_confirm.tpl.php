...
<?php } else if ($this->_rootref['PAGE'] == ('confirm')) {  ?>
			<form name="registration" action="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>confirm.php" method="post">
				...
				<button class="btn btn-primary" type="submit" name="action" value="Confirm"><?php echo ((isset($this->_rootref['L_249'])) ? $this->_rootref['L_249'] : ((isset($MSG['249'])) ? $MSG['249'] : '{ L_249 }')); ?></button>
				<button class="btn btn-danger" type="submit" name="action" value="Refuse"><?php echo ((isset($this->_rootref['L_250'])) ? $this->_rootref['L_250'] : ((isset($MSG['250'])) ? $MSG['250'] : '{ L_250 }')); ?></button>
			</form>
