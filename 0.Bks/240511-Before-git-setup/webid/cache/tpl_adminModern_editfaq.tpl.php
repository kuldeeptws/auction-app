<div style="width:25%; float:left;">
		...
		<div style="width:75%; float:right;">
			<div class="container">
				<h4 class="rounded-top rounded-bottom"><?php echo ((isset($this->_rootref['L_25_0018'])) ? $this->_rootref['L_25_0018'] : ((isset($MSG['25_0018'])) ? $MSG['25_0018'] : '{ L_25_0018 }')); ?>&nbsp;&gt;&gt;&nbsp;<?php echo ((isset($this->_rootref['L_5232'])) ? $this->_rootref['L_5232'] : ((isset($MSG['5232'])) ? $MSG['5232'] : '{ L_5232 }')); ?>&nbsp;&gt;&gt;&nbsp;<?php echo (isset($this->_rootref['FAQ_NAME'])) ? $this->_rootref['FAQ_NAME'] : ''; ?></h4>
				<form name="editfaq" action="" method="post">
					<table class="table table-striped table-bordered">
					<tr>
						<td><?php echo ((isset($this->_rootref['L_5238'])) ? $this->_rootref['L_5238'] : ((isset($MSG['5238'])) ? $MSG['5238'] : '{ L_5238 }')); ?></td>
						<td>&nbsp;</td>
						<td>
...
<?php $_cats_count = (isset($this->_tpldata['cats'])) ? sizeof($this->_tpldata['cats']) : 0;if ($_cats_count) {for ($_cats_i = 0; $_cats_i < $_cats_count; ++$_cats_i){$_cats_val = &$this->_tpldata['cats'][$_cats_i]; ?>
								<option value="<?php echo $_cats_val['ID']; ?>"<?php if ($_cats_val['ID'] == $this->_rootref['FAQ_CAT']) {  ?>selected="selected"<?php } ?>><?php echo $_cats_val['CAT']; ?></option>
<?php }} ?>
							</select>
						</td>
					</tr>
