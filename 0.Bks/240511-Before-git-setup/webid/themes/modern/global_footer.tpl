...
<!-- ENDIF -->
	...
	<div class="copyright">
		{L_COPY}
		<!--
			We request you retain the full copyright notice below including the link to webidsupport.4up.eu.
			...
			"WeBid" linked to webidsupport.4up.eu. If you must remove thte copyright message pelase make
			a donation at http://webidsupport.4up.eu/donate.php to help pay for future developments
		-->
		Powered by <a href="http://webidsupport.4up.eu/">WeBid</a> &copy; 2008 - {L_COPY_YEAR} <a href="http://webidsupport.4up.eu/">WeBid</a>
	</div>
</div>
